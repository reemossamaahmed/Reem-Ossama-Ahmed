                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                            <?php
                                            $cat = $categories->getCategoryName()->get_result();
                                            if ($cat->num_rows >= 1) {
                                                foreach ($cat->fetch_all(MYSQLI_ASSOC) as $category) { ?>
                                                    <li>
                                                        <ul>
                                                            <li class="mega-menu-title"><a href="shop.php?id_category=<?php echo $category['id'] ;?>"><?php echo $category['name_en'] ;?></a></li>
                                                            <?php
                                                                $subcategories->setCategory_id($category['id']);
                                                                $subcat = $subcategories->getSubcategoryName()->get_result();
                                                                if($subcat->num_rows >= 1)
                                                                {
                                                                    foreach ($subcat->fetch_all(MYSQLI_ASSOC) as $subcategory){
                                                                        ?>
                                                                        <li><a href="shop.php?id_subcategory=<?php echo $subcategory['id'] ;?>"><?php echo $subcategory['name_en'];?></a></li>
                                                                    <?php }   
                                                                }
                                                            ?>
                                                        </ul>
