...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2022 at 10:41 PM
...
--
CREATE DATABASE IF NOT EXISTS `e_commerce_project` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `products` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '"1=>active""0=>not active"',
  `price` decimal(10,0) NOT NULL,
  `image` varchar(32) NOT NULL DEFAULT 'default.pnf',
...
CREATE TABLE `users` (
  ...
  `phone` varchar(11) NOT NULL,
  `phone_verified_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `image` varchar(32) DEFAULT 'default.pnf',
...
('root', '[{\"db\":\"e_commerce_project\",\"table\":\"addresses\"},{\"db\":\"e_commerce_project\",\"table\":\"admins\"},{\"db\":\"e_commerce_project\",\"table\":\"brands\"},{\"db\":\"e_commerce_project\",\"table\":\"carts\"},{\"db\":\"e_commerce_project\",\"table\":\"categories\"},{\"db\":\"e_commerce_project\",\"table\":\"cities\"},{\"db\":\"e_commerce_project\",\"table\":\"complains_replies\"},{\"db\":\"e_commerce_project\",\"table\":\"coupons\"},{\"db\":\"e_commerce_project\",\"table\":\"favs\"},{\"db\":\"e_commerce_project\",\"table\":\"offers\"}]');
...
('e_commerce_project', 'addresses', 'street'),
('e_commerce_project', 'complains_replies', 'messege'),
('e_commerce_project', 'products', 'name_en'),
('e_commerce_project', 'products_specs', 'value'),
('e_commerce_project', 'regions', 'name_en'),
('e_commerce_project', 'reviews', 'comment'),
('e_commerce_project', 'subcategories', 'name_en');
...
('root', '2022-05-22 20:41:26', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":182}');
